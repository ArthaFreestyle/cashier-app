<aside class="left-sidebar">
    ...
    <div>
      ...
      <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
        <ul id="sidebarnav" data-widget="treeview" role="menu">
          ...
          @if(Auth::user()->hasRole->Permitted('read '.$menu->name))
            <li class="nav-small-cap">
            <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
            <span class="hide-menu">{{ $menu->name }}</span>
        </li>
              @foreach ($menu->subMenus as $submenu)
              @if(Auth::user()->hasRole->Permitted('read '.$submenu->url))
              <li class="sidebar-item active">
                <a class="sidebar-link" href="{{url($submenu->url)}}" aria-expanded="false">
                  <span>
          ...
          <li class="sidebar-item active">
            <a class="sidebar-link" href="#" aria-expanded="false">
              ...
              <span class="hide-menu ">Input New Item</span>
            </a>
          </li>
